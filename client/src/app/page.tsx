  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center h-screen gap-5">
        <div className="w-12 h-12 border-[3px] border-primary/20 rounded-full border-t-primary animate-spin"></div>
        <p className="text-slate-400 text-sm">Syncing secure session...</p>
      </div>
    );
  }
